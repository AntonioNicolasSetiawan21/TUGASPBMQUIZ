...
class QuizzlerApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        backgroundColor: Color.fromARGB(255, 64, 82, 92),
        appBar: AppBar(
          title: Center(child: Text('KUIS PENGETAHUAN KUY')), // Judul appbar
          backgroundColor: Color.fromARGB(255, 26, 15, 231), // Warna appbar
        ),
        body: const SafeArea(
          child: Padding(
    ...
    setState(() {
      if (quizBrain.isFinished()) {
        ...
        if (userPickedAnswer == correctAnswer) {
          ...
          scoreKeeper.add(const Icon(
            Icons.close,
            color: Color.fromARGB(255, 186, 2, 247),
          ));
          numIncorrect++;
        }
          ...
          child: Padding(
            ...
            child: TextButton(
              ...
              style: const ButtonStyle(
                backgroundColor:
                    MaterialStatePropertyAll(Color.fromARGB(255, 8, 239, 97)),
                foregroundColor:
                    MaterialStatePropertyAll(Color.fromARGB(255, 18, 18, 18)),
        ...
        Expanded(
          child: Padding(
            ...
            child: TextButton(
              ...
              style: const ButtonStyle(
                backgroundColor:
                    MaterialStatePropertyAll(Color.fromARGB(255, 24, 22, 22)),
                foregroundColor:
                    MaterialStatePropertyAll(Color.fromARGB(255, 197, 7, 240)),
                textStyle: MaterialStatePropertyAll(
                  TextStyle(fontSize: 20.0),
                ),
              ),
